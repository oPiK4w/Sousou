...
client.login("NDk2MzU5MTI0MjYzNzYzOTY4.DpP8Ww.KTNY7Sh-iQpm6gIea35bM67vilM");
...
client.on('message', async message => { 
    ...
    if (message.content === prefix + "forum"){
        message.channel.sendMessage("**Voici le forum :** https://www.hyzofight.eu/forum/index.php/n%22");
        console.log('Commande Exécuté');
    }

    if (message.content === prefix + "ip"){
        message.channel.sendMessage("**Voici l'ip de notre serveur :** mc.hyzofight.eu");
        console.log('Commande Exécuté');
    }

    if (message.content === prefix + "info-serveur"){
        message.channel.sendMessage(" **\n\n Bienvenue sur le serveur discord offciel de HyzoFight\n\n ▸ Serveur 1.8x.1.12x - FFA-Rush - SkyBlock - Faction\n\n Voici HyzoFightV3 ! Un serveur fluide , un staff compétent , des maps inédites , des nouveaux jeux qui n'était pas sur la V2 !\n\n ⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝⇝\n\n Informations:\n\n -Twitter: @HyzoFightV3\n\n -TeamSpeak\n\n - Minecraft : mc.hyzofight.eu : ts.hyzofight.eu\n\n Version : 1.8x/1.12x**");
        console.log('Commande Exécuté');
    }

    if (message.content === prefix + "invite"){
        message.channel.sendMessage("**Voici l'invatation pour que je puisse venir sur votre serveur discord :**\n\n https://discordapp.com/oauth2/authorize?client_id=496359124263763968&scope=bot&permissions=8");
        console.log('Commande Exécuté');
    }
    ...
    if(message.content === prefix + "help") {
      ...
      .addField(":sunny: HyzoFight", "Fais `/hyzofight` pour voir mes commandes du serveur HyzoFight !")
      .setFooter("Menu d'aide - HyzoBot")
      .setTimestamp()
    ...
    if(message.content === prefix + "mod") {
      ...
      .setFooter("Commande modération - HyzoBot")
      .setTimestamp()
    ...
    if(message.content === prefix + "fun") {
      ...
      .addField("/invite", "Donne le lien du bot pour que vous l'invitiez sur votre discord !")
      .setFooter("Commande fun - HyzoBot")
      .setTimestamp()
      message.channel.send(fun_embed);
    }

    if(message.content === prefix + "hyzofight") {
        var fun_embed = new Discord.RichEmbed()
        .setColor('RANDOM')
        .setTitle(`:tools: Voici mes commandes du serveur HyzoFight !`)
        .setThumbnail(message.author.avatarURL)
        .addField(" - Le /forum permet de voir le lien du forum","Voir le forum ! ")
        .addField(" - Le /ip permet de voir l'ip du serveur HyzoFight", "Voir l'ip du serveur")
        .addField(" - Le /info-serveur permet de voir toutes les informations du serveur HyzoFight", "Info du serveur")
        .setFooter("Commande HyzoFight - HyzoBot")
        .setTimestamp()
        message.channel.send(fun_embed);
      }
  ...
  case "stop":
    ...
    if(message.content === prefix + "info") {
        ...
        .addField("Créer par Soutshy", "Créateur Soutshy")
        .addField("Date de création : Soon", "Soon")
        .setFooter("Info - HyzoBot")
